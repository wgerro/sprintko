            ...
            <div class="panel panel-default panel-ko" >
                <div class="panel-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                          <input id="textinput" name="subject" type="text"  class="form-control input-md" value="{{ old('subject') }}" required>
                        ...
                        <div class="form-group">
                                  ...
                                  <div class="col-md-8"  style="height:180px; overflow-y:scroll;">
                                    @foreach($category as $cat)
                                        <input type="checkbox" id="cat-{{ $cat->id }}" value="{{$cat->id}}" name="category_id[]" @if(count(old('category_id'))) {{ (in_array($cat->id, old('category_id')))?'checked':'' }} @endif>
